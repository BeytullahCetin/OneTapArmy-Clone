...
namespace ASze.CustomPlayButton
{
    ...
    public static class CustomPlayButton
    {
        ...
        static GUIContent deleteSavesContent;
        ...
        static CustomPlayButton()
        {
            ...
            deleteSavesContent = CreateIconContent("DeleteIcon.png", "P4_DeletedLocal@2x", "Delete Saves");
        }
        ...
        static void OnToolbarLeftGUI()
        {
            ...
            if (GUILayout.Button(deleteSavesContent, ToolbarStyles.commandButtonStyle))
            {
